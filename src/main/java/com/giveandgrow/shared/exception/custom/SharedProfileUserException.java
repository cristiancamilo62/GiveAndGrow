...
public class SharedProfileUserException extends ProfileUserException {

	@Serial
	private static final long serialVersionUID = 1L;
	private static final LocationException location = LocationException.SHARED;

	public SharedProfileUserException(final String userMessage) {
		super(userMessage, location);
	}

	public SharedProfileUserException(final String technicalMessage, final String userMessage) {
