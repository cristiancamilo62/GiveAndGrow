...
public class EventDomain {
    ...
    public EventDomain(UUID id, String name, LocalDateTime startDateTime, LocalDateTime registerDeadline, String location, String category, String description, UUID organizationId) {
        setId(id);
        setName(name);
